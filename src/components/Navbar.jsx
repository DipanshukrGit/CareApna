...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-transparent backdrop-blur-sm py-2">
      <div className="max-w-7xl mx-auto">
        {/* Desktop Navbar */}

        <div className="hidden md:flex items-center justify-between bg-white py-3 px-4 rounded-2xl border border-gray-200 shadow-sm">
        <Link to="/" className="flex items-center gap-3">
          <img src={assets.logo} alt="CareApna Logo" className="h-10 w-auto object-contain" />
          <span className="text-2xl font-bold text-[#231F69]">CareApna</span>
        </Link>
        ...
        <div className="md:hidden bg-white py-3 px-4 rounded-2xl border border-gray-200 shadow-sm">
        <div className="flex items-center justify-between">
          <Link to={"/"} className="flex items-center gap-2">
            <img src={assets.logo} alt="CareApna Logo" className="h-8 w-auto object-contain" />
            <span className="text-xl font-bold text-[#231F69]">CareApna</span>
          </Link>
